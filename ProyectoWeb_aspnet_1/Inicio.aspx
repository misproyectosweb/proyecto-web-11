<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="ProyectoWeb_aspnet_1.Inicio" %>
        ...
        <div class="container-fluid py-4">
            <div class="row align-items-center mb-5">
                <div class="col-6 px-5">
                    <h6 class="my-3"><strong>1. Identifica el aroma</strong></h6>
            ...
            <div class="row mr-5 mb-5 justify-content-end align-items-center">
                ...
                <div class="col-6 px-5">
                    <h6 class="my-3"><strong>2. Saborea cada sorbo</strong></h6>
            ...
            <div class="row align-items-center mb-5">
                <div class="col-6 px-5">
                    <h6 class="my-3"><strong>3. Paladea la textura</strong></h6>
            ...
            <div class="row mr-5 justify-content-end align-items-center">
                <div class="col-6 text-right">
                    <img src="imagenes/imgCafe_7.png" class="img-fluid"/>
                </div>
                <div class="col-6 px-5">
                    <h6 class="my-3"><strong>4. Disfruta hasta el final</strong></h6>
