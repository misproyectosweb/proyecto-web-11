...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="imgFondoInicio vh-100">
        <div class="colorFondo vh-100">
            <div class="col-7">
                <div class="row px-4">
                    <blockquote class="blockquote text-center text-white citaInicio py-5">
    ...
    <div class="row justify-content-center py-5">
        <div class="text-center titulo">            
            <h1 class="mb-0 text-center display-4 py-4">¿Cómo disfrutar tu café?</h1>
            <h2 class="mb-0 text-center">Creando un momento especial</h2>
        </div>
    </div>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row mr-5 mb-5 justify-content-end align-items-center">
            <div class="px-5 col-6 text-right">
