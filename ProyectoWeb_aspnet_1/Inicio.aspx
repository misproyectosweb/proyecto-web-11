...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="imgFondoInicio">
        <div class="colorFondoInicio">
            <div class="col-7">
                <div class="row px-4">
                    <blockquote class="blockquote text-center text-white py-5">
                        <p class="citaInicio pl-3">" Es posible que la ciencia nunca presente un mejor sistema de comunicación en la oficina que el descanso para tomar café "</p>
