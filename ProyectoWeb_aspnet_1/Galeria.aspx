    ...
    <div class="py-5">
        ...
        <div class="row px-3 pt-4">  
            <%--<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_1.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">                    
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_2.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_3.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">                    
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_4.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">                    
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_5.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_6.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">                    
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_7.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_8.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_9.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_10.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_11.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 d-flex flex-row justify-content-center">
                <figure class="figure">
                    <img src="imagenes/fotoHistoriaCafe_12.jpg" class="figure-img img-fluid img-thumbnail rounded-lg p-2 bg-info mx-auto d-block" alt="imagen">
